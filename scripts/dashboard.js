  ...
  cards.innerHTML = `
    <a class="dashboard-card dashboard-card--selector" href="exams.html">
      ...
      <div class="dashboard-card__details">
        ...
        <div class="dashboard-card__detail"><strong>Access</strong><span>Exam reviewer role</span></div>
      </div>
    </a>
    <a class="dashboard-card dashboard-card--selector" href="aos-dashboard.html">
      ...
      <div class="dashboard-card__details">
        ...
        <div class="dashboard-card__detail"><strong>Access</strong><span>AOS dashboard role</span></div>
      </div>
    </a>
  `
})()